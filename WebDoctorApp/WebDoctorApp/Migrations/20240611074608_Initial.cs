        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "Lek przeciwzapalny, przeciwbólowy i przeciwgorączkowy", "Ibuprofen", "Kapsułka" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateOnly(2000, 5, 15), "Kornel", "Kowalski" },
                    { 2, new DateOnly(1990, 5, 15), "Pola", "Policja" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateOnly(2024, 6, 10), new DateOnly(2024, 6, 17), 1, 1 },
                    { 2, new DateOnly(2024, 6, 11), new DateOnly(2024, 6, 18), 2, 2 }
                });

            migrationBuilder.InsertData(
                table: "PrescriptionMedicament",
                columns: new[] { "IdMedicament", "IdPrescription", "Details", "Dose" },
                values: new object[] { 1, 1, "Twice a day after meal", 2 });
